...
echo "MAFFT_FORMAT:  $MAFFT_FORMAT"
...
diffblast.sh $QUERY_FASTA INITIAL_BLAST.blast $PREVIOUS_FILE $SEQUENCE_OUTPUT $MAFFT_OUTPUT $RTF_OUTPUT $ECUTOFF $MAFFT_FORMAT

cp INITIAL_BLAST.blast _last.blast
